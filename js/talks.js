async function loadTalks() {
    try {
        ...
        if (talks.length === 0) {
            talksContainer.innerHTML = `
                <p>No talk is published yet. <a href="https://gdg.community.dev/events/details/google-gdg-philadelphia-presents-gdg-philly-devfest-2025/" class="join-btn">Call for Speakers</a></p>
            `;
            return;
        }
